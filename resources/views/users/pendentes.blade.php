...
@section('content')
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td>{{isset($pendente['num_socio']) ? $pendente['licenca_confirmada'] == 0 ? 'Sócio com licença não confirmada' : 'Sócio com certificado não confirmado' : !is_null($pendente['tipo_conflito'])?'Movimento com conflito': 'Movimento não confirmado' }}</td>
